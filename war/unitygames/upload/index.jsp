...
function tagCheck(){
	...
	<br>
	<br>
	<form action="upload" method="post" 　class="cmxform"
		...
		<table class="purchase-options" border="0" align="center">
				...
				<td rowspan="6">
					...
					<div id="wrapper" align="center"　>
						<button id="regist" class="button"
							style="position: relative; top: 30px; width: 250px; height: 80px; font-size: xx-large;">
			...
			<tr>
				<td><h2>
						<label for="GameName"><fmt:message key="gameName" />
						</label><input type="text" name="GameName" id="GameName" class="required" />
					</h2>
				</td>
			</tr>
			<tr>
				...
				</label><br> <fmt:message key="thumbNail.process" /><br> <label><input
						type="radio" name="ThumbNailType" value="data" id="tdata" checked>
					<fmt:message key="thumbNail.pictureDataUp" />
				</label><br> <label><input type="radio" name="ThumbNailType"
						value="url" id="turl">
					<fmt:message key="thumbNail.urlUp" /><br>
				</label>
				</td>
			...
			<tr>
				<td><div id="tf">
					...
					<div id="tu">
						<label for="ThumbNailURL"><fmt:message key="thumbNail.url" />
						</label><input type="text" name="ThumbNailURL" id="ThumbNailURL"
							style="width: 260px"
			...
			<tr>
				...
				</label><br> <fmt:message key="gamedata.process" /><br> <label><input
						type="radio" name="GameType" value="data" id="data" checked>
					<fmt:message key="game.select.data" />
				</label><br> <label><input type="radio" name="GameType"
						value="url" id="url">
					<fmt:message key="game.select.url" /><br>
				</label> <label><input type="radio" name="GameType" value="hpurl"
						id="hp">
					<fmt:message key="game.select.url.outside" /><br>
				</label>
				</td>
			</tr>
			<tr>
				<td>
					<div id="G1">
						<label for="GameData"><fmt:message key="game.data" />
						</label> <input type="file" name="GameFile" id="GameData"><br>
					</div>
					<div id="G2">
						<label for="GameURL"><fmt:message key="game.url" />
						</label> <input type="text" name="GameURL" id="GameURL"
							style="width: 260px" title="<fmt:message key="game.url.title" />" /><br>
					</div>
					<div id="G3">
					...
					<div style="position: relative; top: 20;">
						<b><fmt:message key="fixTag.explanation" />
						</b>
						<h2>

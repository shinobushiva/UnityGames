					...
					<div style="width: 500px; padding-left: 10px; padding-right: 10px;">
						...
						<div class="gameView">
							...
							<div style="clear: both;">
								<div
									style="float: left; font-size: 20px; position: relative; top: -10px; margin-top: 0.3em; margin-left: 8em;">
									<span><fmt:message key="access" />：${g.access}</span> <span><fmt:message
											key="comment" />：${g.comment}</span>
								</div>
								<div align="right">
